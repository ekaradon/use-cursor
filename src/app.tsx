...
import { Cursor, useCursorOnHover, useCursorStyle } from './lib'
...
function Title() {
  return (
    <h1 className="title" ref={useCursorOnHover('Effect.Grow')}>
      Hover me!
    </h1>
  )
}
...
function Paragraph() {
  return (
    <p className="paragraph" ref={useCursorOnHover('Effect.Difference', 'Shape.Circle')}>
